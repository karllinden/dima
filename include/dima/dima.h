 ...
 * a pointer to the struct dima implementation as their first argument, which is
 ...
 * setting flags. See for example dima_init_exiting_on_failure and
 * dima_init_pthread_mutex_locked. Clients may depend on any additional
 * guarantees, but they should document any additional requirements, either in
 * comments or by asserting on flags.
 *
